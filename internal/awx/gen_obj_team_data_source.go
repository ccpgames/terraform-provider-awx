...
func (o *teamDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (o *teamDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
