...
func (o *groupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (o *groupDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
